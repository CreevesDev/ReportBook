...
public class ReportCmd implements CommandExecutor, Listener, TabCompleter {
    ...
    public String getFriendlyName(String name) {
        for (String nameLoc : ReportBook.dataManager.getPlayerList().values()) {
            if (name.equalsIgnoreCase(nameLoc)) {
                return nameLoc;
            }
        }
        return "false";
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (reportedUser.equalsIgnoreCase(sender.getName())) {
        ...
        if (categoryArgs.length() > 18) argumentsShort = categoryArgs.substring(0, 18) + "...";
    ...
    public List<String> onTabComplete(CommandSender commandSender, Command command, String label, String[] args) {
        ...
        if (!commandSender.hasPermission("reportbook.report")) return tabComplete;
        if (args.length == 1) {
